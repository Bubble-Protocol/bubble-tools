...
import { addressBook, wallet, contractTools } from "./bubble-tools.mjs";
import { paramToHex } from "./bubble-utils.mjs";
...
export function mintNft(contractAddress, series, tokenId, recipientAddress, options) {
  ...
  return contractTools.transact(contractAddress, 'mint', [seriesHex, tokenIdHex, recipientAddress], {...options, abi: BubbleNFTAbi})
}
